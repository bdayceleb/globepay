    ...
    return (
        <div className="min-h-screen bg-[#F8FAFC] flex flex-col justify-center items-center px-4">
            <div className="w-full max-w-md bg-white rounded-3xl shadow-xl p-10">
                ...
                <h2 className="text-2xl font-bold text-center text-[#0A1128] mb-8">Log in to GlobePay</h2>
                ...
                <p className="mt-8 text-center text-sm text-gray-600">
                    New to GlobePay? <Link href="/register" className="text-[#00B9FF] font-bold hover:underline">Register</Link>
                </p>
            </div>
        </div>
    );
