    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch('/api/kyc/submit', {
                ...
                body: JSON.stringify({ fullName, aadharCard, panCard }),
            });
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            required
                            value={aadharCard}
                            onChange={(e) => setAadharCard(e.target.value.replace(/\D/g, '').substring(0, 12))}
                            className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-[#00B9FF] focus:border-transparent outline-none transition"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            required
                            value={panCard}
                            onChange={(e) => setPanCard(e.target.value.toUpperCase().substring(0, 10))}
                            className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-[#00B9FF] focus:border-transparent outline-none transition"
